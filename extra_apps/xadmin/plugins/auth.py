...
class UserAdmin(object):
    ...
    list_display = list_display = ['id', 'username', 'is_superuser', 'is_active', 'email', 'mobile_phone',
                    'date_joined', 'last_login_ip_frontend', 'last_login_ip_backend'] #('username', 'email', 'first_name', 'last_name', 'is_staff')
